...
const EditProfilePage = () => {
  return (
    <div className="pt-6 max-w-250">
      <div className="font-inter font-normal text-2xl leading-9 text-white flex gap-x-16 ml-3 border-b border-[#192D71] pb-2">
      ...
      <div className="mt-10">
        ...
        <div className="mt-20 flex items-center justify-center cursor-pointer">
          <button className="py-2 px-39 bg-[#00C950] font-inter font-bold text-[20px] leading-[150%] text-white rounded-[12px]">
            Save
          </button>
        </div>
      </div>
